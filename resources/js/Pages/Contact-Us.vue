...
<template>
    ...
    <GuestLayout>
        <main class="dark:text-[#FAF9F6]">
            <!-- Hero Section -->
            <section class="pt-56 lg:pt-0 hero-section min-h-screen text-[#000] px-4 md:px-10 lg:px-32 flex flex-col lg:flex-row items-center">
            ...
            <section class="text-[#000] mb-10 lg:mb-20 px-4 md:px-10 lg:px-32 flex flex-col lg:flex-row gap-6 lg:gap-1">
                <!-- Contact Form -->
                <div class="w-full lg:w-1/2 px-4 sm:px-5 py-8 lg:py-10 flex flex-col gap-4 lg:gap-5">
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    type="text"
                                    id="title"
                                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3 md:p-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="John Doe"
                                    required
                            ...
                            <div class="relative my-3">
                                ...
                                <input
                                    ...
                                    type="text"
                                    id="title"
                                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3 md:p-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="johndoe@gmail.com"
                                    required
                                    :disabled="form.processing"
                                />
                            </div>
                            ...
                            <div class="relative mb-4 lg:mb-5">
                                ...
                                <input
                                    ...
                                    type="text"
                                    id="title"
                                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3 md:p-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Subject of your concern"
                                    required
                                    :disabled="form.processing"
                                />
                            </div>
                ...
                <!-- Contact Info & Map -->
                <div class="w-full lg:w-1/2 px-4 sm:px-5 py-8 lg:py-10 flex flex-col gap-4 lg:gap-5 border rounded">
                    <div class="w-full h-auto grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-2">
                        <div class="flex items-center gap-1 justify-center py-5 lg:py-0 bg-white shadow-md rounded-lg dark:bg-[#2c2c2c]">
                            <ApplicationImage />
                        ...
                        <div v-for="(contact, index) in contacts" :key="index" class="bg-white flex justify-center items-center shadow-md rounded-lg dark:bg-[#2c2c2c] p-4">
                    ...
                    <div class="w-full h-64 sm:h-80 lg:h-full">
