                ...
                <div>
                    ...
                    <div class="flex justify-center mb-5">
                        <div class="w-16 h-16 rounded-full flex items-center justify-center bg-red-100">
                            <img :src="'/Images/SVG/warning.svg'" alt="Warning Icon">
                        </div>
                    </div>

                    <!-- Content -->
                    <div class="text-center">
                        <h5 class="font-bold text-2xl">You are about to reject a report</h5>
                        <p>Are you sure you want to reject this report? This action cannot be undone.</p>
                    </div>
                </div>
